...
function GameScreen({ mode, onBackToMenu }: { mode: Mode; onBackToMenu: () => void }) {
  ...
  const onTileClick = (idx: number) => {
    ...
    setStats((s) => ({
      ...
      goodMoves: s.goodMoves + (currentUke >= bestUke ? 1 : 0),
    }));
    ...
    const top3 = [...all]
      .sort((a, b) => b.score - a.score || b.mCount - a.mCount || b.mKinds - a.mKinds)
      .slice(0, 3);
  ...
  return (
    ...
    >
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <div style={{ display: "flex", gap: 6 }}>
          ...
          <button
            ...
            style={{ padding: isDesktop ? "6px 10px" : "4px 8px", fontSize: isDesktop ? 14 : 11 }}
          >
            New Game
          </button>
        </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr auto", gap: 6, alignItems: "start", minHeight: isDesktop ? 120 : isMini ? 68 : 78 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 4, paddingTop: isMini ? 8 : 10 }}>
          <button
            ...
            style={{ padding: "4px 8px", minWidth: isDesktop ? 74 : isMini ? 50 : 56, fontSize: isDesktop ? 14 : isMini ? 10 : 11 }}
          >
            Undo
          </button>
          <button
          ...
          <span style={{ color: "#bbe7d5", width: isDesktop ? 160 : isMini ? 84 : 96, fontSize: isDesktop ? 12 : isMini ? 8 : 9, lineHeight: 1.2 }}>
            {undoDiffMsg}
          </span>
        </div>
      </div>
      ...
      <div style={{ display: "flex", alignItems: "center", overflowX: "auto", paddingBottom: 2, minHeight: isDesktop ? 66 : isMini ? 44 : 48 }}>
        {fullHand.slice(0, 13).map((t, i) => (
          <button
            ...
            style={{
              width: isDesktop ? 44 : isMini ? 27 : 30,
              height: isDesktop ? 60 : isMini ? 38 : 42,
              padding: 0,
              borderRadius: 0,
        ...
        {fullHand[13] != null && (
          <button
            ...
            style={{
              ...
              marginLeft: isDesktop ? 14 : isMini ? 6 : 8,
              background: "#13523d",
              cursor: gameEnded ? "default" : "pointer",
              flex: "0 0 auto",
            }}
      ...
      <div
        style={{
          padding: isDesktop ? 8 : isMini ? 3 : 4,
          borderRadius: 8,
          background: "#00552e",
          fontSize: isDesktop ? 14 : isMini ? 8 : 9,
          minHeight: isDesktop ? 108 : isMini ? 60 : 70,
          overflow: "hidden",
        }}
      >
        {resultMsg ? (
          <div style={{ fontWeight: 700, color: "#ffe082", fontSize: isDesktop ? 22 : isMini ? 12 : 14 }}>
            {resultMsg}
          </div>
        ) : null}
        ...
        <div style={{ minHeight: isDesktop ? 20 : isMini ? 10 : 12 }}>
          {selectedUke ? `メンツ手 受け入れ: ${selectedUke.mentsuKinds}種 ${selectedUke.mentsuCount}枚${isMentsuShantenBack ? "（シャンテン戻し）" : ""}` : ""}
        </div>
        <div style={{ minHeight: isDesktop ? 20 : isMini ? 10 : 12 }}>
          {selectedUke ? `七対子 受け入れ: ${selectedUke.chiitoiKinds}種 ${selectedUke.chiitoiCount}枚` : ""}
        </div>
            ...
            {row.map((t, i) => (
              <span
                ...
                style={{
                  ...
                  padding: "1px",
                  background: "#184f3b",
                  width: desktop ? 36 : compact ? 16 : 32,
                  height: desktop ? 52 : compact ? 22 : 46,
                }}
              >
